...
public class StudentModel {
	...
	/**
	 * Find by email record in database
	 * 
	 * @param Email
	 * @return
	 * @throws ApplicationException
	 ...
	 */
	public void update(StudentBean bean) throws ApplicationException, DuplicateRecordException, RecordNotFoundException {
		...
		try {
			...
			try {
				...
				throw new ApplicationException("Exception in updating Student"+ex.getMessage());
