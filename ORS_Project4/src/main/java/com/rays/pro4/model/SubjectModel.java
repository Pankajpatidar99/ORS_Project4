	...
	public void update(SubjectBean bean) throws ApplicationException, DuplicateRecordException {
		 ...
		 */
		 ...
		 try {
			 conn=JDBCDataSource.getConnection();
			 conn.setAutoCommit(false);
			 PreparedStatement pstmt = conn.prepareStatement("UPDATE ST_SUBJECT SET SUBJECT_NAME=?,DESCRIPTION=?,CourseName=?,CourseName=?,CREATED_BY=?,MODIFIED_BY=?,CREATED_DATETIME=?,MODIFIED_DATETIME=? WHERE ID=?");
	 ...
	 /**
	  * Find record by name in database
	  * 
	 * @param name
	 * @return
	 * @throws ApplicationException
