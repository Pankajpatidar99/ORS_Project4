...
<%@ include file="Header.jsp"%>
        ...
        <%
            List li = (List) request.getAttribute("studentList");
            ...
            <table align="center">
                ...
                <tr><th style="padding: 3px"></th></tr>
                  ...
                  <tr>
                    ...
                    <td><%=HTMLUtility.getList("studentld",String.valueOf(bean.getStudentld()),li)%></td>
                ...
                <tr>
                    <th align="left">Chemistry<span style="color: red">*</span> :</th>
                     <td><input type="number" name="chemistry" maxlength="3" placeholder="Enter Chemistry Marks"  style="width:208px"
                        value="<%=(DataUtility.getStringData(bean.getChemistry()).equals("0")?"0":DataUtility.getStringData(bean.getChemistry()))%>">
                        </td>
                ...
                <tr >
                  ...
                  <td><input type="number" name="maths" maxlength="3" placeholder="Enter Maths Marks"  style="width:208px"
                         value="<%=(DataUtility.getStringData(bean.getMaths()).equals("0")?"0":DataUtility.getStringData(bean.getMaths()))%>">
                        </td>
